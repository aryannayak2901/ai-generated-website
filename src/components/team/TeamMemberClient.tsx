...
export default function TeamMemberClient({ member }: Props) {
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans">
      {/* Hero Section - Primary background with accent accents */}
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-8 lg:gap-12 items-center md:items-start">
            ...
            <motion.div 
              ...
              className="relative shrink-0 w-64 h-80 rounded-2xl overflow-hidden border-4 border-white/10 shadow-2xl bg-primary flex items-center justify-center"
            >
              {member.image ? (
                <Image
                  src={member.image}
