...
export function AboutCta({ className }: { className?: string }) {
  return (
    <section
      className={cn(
        "relative py-24 px-6 bg-navy overflow-hidden",
        className,
      )}
    >
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <h2 className="font-serif text-4xl md:text-6xl font-bold text-white mb-8 leading-tight">
            Ready to Secure Your <span className="text-gold">Legal Future</span>?
          </h2>
          <p className="text-lg md:text-xl text-slate-300 mb-12 font-sans max-w-2xl mx-auto leading-relaxed">
            Our team of dedicated advocates is prepared to provide the strategic 
            representation and expert counsel you deserve. Schedule your consultation today.
          </p>
