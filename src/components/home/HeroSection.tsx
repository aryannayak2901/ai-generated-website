...
export function HeroSection({
  ...
  return (
    <section className="relative w-full min-h-[60vh] lg:min-h-[70vh] flex items-center bg-charcoal-primary overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1280px] mx-auto px-6 md:px-8 lg:px-12 py-20 lg:py-32">
        <div className="max-w-3xl">
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl lg:text-2xl text-slate-secondary font-sans leading-relaxed mb-10 max-w-2xl"
          >
            {subtitle}
          </motion.p>
