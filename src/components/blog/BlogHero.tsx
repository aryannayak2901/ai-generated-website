        ...
        <div className={`grid grid-cols-1 gap-12 ${postData ? 'lg:grid-cols-2 lg:gap-20' : 'max-w-3xl'}`}>
          ...
          {postData && (
            ...
            >
              ...
              >
                <div className="relative overflow-hidden rounded-xl bg-primary border border-white/10 backdrop-blur-xl hover:border-accent/20 transition-all duration-700 shadow-2xl hover:shadow-accent/5">
                  {/* Image Container */}
